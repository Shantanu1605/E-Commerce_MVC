...
namespace BulkyWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //defining of the other properties that we want
            [Required]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //populating other properties from the input model
                ...
                if (Input.Role == SD.Role_Company)
                {
                    ...
                    // Thus after clicking on regiter in our database the column for companyId will get filled up with the companyId selected by the user
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    else // agar user ne role specify nhi kiya to hum usko by default customer role hi asssign karenge
                    {
